...
# repository location
set :repository, "ssh://git@bitbucket.org/andreasnovak/redmine.git"
...
set :deploy_to, "/home/user09042002/rails1"
...
namespace :railshoster do
  ...
  task :appurl do
    ...
    puts "\nhttp://user09042002-1.ny.railshoster.de"    
    puts "\n"
  end
end
